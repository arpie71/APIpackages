...
hlapi_overview<-function(entity.type=NULL, sort = NULL, fields=FALSE,collections=FALSE, coll.name=NULL, limit=25, start.date=NULL, end.date=NULL, run=FALSE,...){
...
#"http://api.foiarchive.org/entities?entity_type=eq.country&corpus=eq.frus&order=ref_cnt.desc&limit=5"
#"http://api.foiarchive.org/entities?entity_type=eq.topic&corpus=eq.frus&order=ref_cnt.desc&limit=5"
#"http://api.foiarchive.org/entities?entity_type=eq.person&corpus=eq.frus&order=ref_cnt.desc&limit=5"


#"http://api.foiarchive.org/entities?entity_type=eq.person&corpus=eq.frus&order=ref_cnt.desc&limit=5&authored=gte.1978-09-06"

hlapi_overview(coll.name='frus', entity.type = 'persons', sort = "A")
hlapi_overview(coll.name='frus', entity.type = 'persons')
hlapi_overview(coll.name='frus', entity.type = 'persons', sort = "As")
