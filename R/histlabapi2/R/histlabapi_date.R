...
#"http://13.59.248.54:3000/docs?authored=eq.1978-08-31&select=doc_id,classification,title"
# http://13.59.248.54:3000/docs?authored=gte.1978-08-31&authored=lte.1978-09-06&select=doc_id,classification,title
...
hlapi_date(date='1980-09-15', fields=c("doc_id","classification","title"), run=TRUE)

h<-hlapi_date(start.date='1947-01-01', end.date='12/01/1948', entity.type="topics" , limit=100,run=TRUE)
h<-hlapi_date(start.date='1947-01-01', end.date='12/01/1948', entity.type="countries" , limit=100,run=TRUE)
hlapi_date(start.date='1947-01-01', end.date='12/01/1948', entity.type="persons" , limit=100,run=TRUE)

h<-hlapi_date(start.date='1947-01-01', end.date='12/01/1948', entity.type=c("topics","countries") , limit=100,run=TRUE)
